namespace WinTail
{
    ...
    public class FileValidatorActor : UntypedActor
    {
        ...
        protected override void OnReceive(Object messgae)
        {
            var msg = messgae as string;
            ...
            else
            {
                ...
                if (valid)
                {
                    ...
                    _consoleWriterActor.Tell(
                                             new Messages.InputSuccess(String.Format("Starting processing for {0}", msg)));
                ...
                else
                {
                    ...
                    // tell sender to conting doing its thing (whatever that may be, this actor doesn't care)
                    Sender.Tell(new Messages.ContinueProcessing());
                }
            }
        }
