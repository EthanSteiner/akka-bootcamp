namespace WinTail
{
    ...
    public class FileObserver : IDisposable
    {
        ...
        public void Start()
        {
            ...
            // Environment.SetEnvironmentVariable("MONO_MANAGED_WATCHER","enabled");  // uncomment this line if you are using mono

            // make wathcer to observe oiur specific file
        ...
        private void OnFileChanged(object sender, FileSystemEventArgs e)
        {
            if (e.ChangeType == WatcherChangeTypes.Changed)
            {
                ...
                // since this event can happen many times, this is a little microopotimization
